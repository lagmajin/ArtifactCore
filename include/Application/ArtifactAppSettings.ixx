...
public:
    ...
    bool timelineAutoKeyEnabled() const;
    void setTimelineAutoKeyEnabled(bool enable);
    QString timelineAutoKeyScopeText() const;
    void setTimelineAutoKeyScopeText(const QString& value);
    bool timelineGhostingEnabled() const;
    void setTimelineGhostingEnabled(bool enable);
    int timelineGhostingFrameCount() const;
    void setTimelineGhostingFrameCount(int count);
    int timelineGhostingOpacity() const;
    void setTimelineGhostingOpacity(int percent);
    QString timelineKeyingSetModeText() const;
    void setTimelineKeyingSetModeText(const QString& value);
    QStringList timelineCustomKeyingSetPropertyPaths() const;
    void setTimelineCustomKeyingSetPropertyPaths(const QStringList& paths);
