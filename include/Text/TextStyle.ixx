...
export struct ParagraphStyle {
  ...
  struct PathBinding { double startOffset=0.0; double endOffset=0.0; bool reversePath=false; bool alignToPath=true; }; std::optional<PathBinding> pathBinding; bool operator==(const ParagraphStyle &other) const = default;
};
