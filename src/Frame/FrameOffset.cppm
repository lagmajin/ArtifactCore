...
FrameOffset FrameOffset::operator+(const FrameOffset& other) const { return FrameOffset(value() + other.value()); }
FrameOffset FrameOffset::operator-(const FrameOffset& other) const { return FrameOffset(value() - other.value()); }
FrameOffset FrameOffset::operator+(int frames) const { return FrameOffset(value() + frames); }
FrameOffset FrameOffset::operator-(int frames) const { return FrameOffset(value() - frames); }
FrameOffset FrameOffset::operator*(int multiplier) const { return FrameOffset(value() * multiplier); }
...
FrameOffset& FrameOffset::operator+=(const FrameOffset& other) { setValue(value() + other.value()); return *this; }
FrameOffset& FrameOffset::operator-=(const FrameOffset& other) { setValue(value() - other.value()); return *this; }
FrameOffset& FrameOffset::operator+=(int frames) { setValue(value() + frames); return *this; }
FrameOffset& FrameOffset::operator-=(int frames) { setValue(value() - frames); return *this; }
FrameOffset& FrameOffset::operator*=(int multiplier) { setValue(value() * multiplier); return *this; }
...
FrameOffset FrameOffset::operator-() const { return FrameOffset(-value()); }
bool FrameOffset::operator==(const FrameOffset& other) const { return value() == other.value(); }
bool FrameOffset::operator!=(const FrameOffset& other) const { return !(*this == other); }
bool FrameOffset::operator<(const FrameOffset& other) const { return value() < other.value(); }
bool FrameOffset::operator<=(const FrameOffset& other) const { return value() <= other.value(); }
bool FrameOffset::operator>(const FrameOffset& other) const { return value() > other.value(); }
bool FrameOffset::operator>=(const FrameOffset& other) const { return value() >= other.value(); }
bool FrameOffset::isZero() const { return value() == 0; }
bool FrameOffset::isPositive() const { return value() > 0; }
